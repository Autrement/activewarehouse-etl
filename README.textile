...
[Update 12/2017] : wow, if you read this, I hope you won't have to use this legacy code in Rails 5 like me. Anyway, this fork is intended to bring support for Rails 5.0 (possibly 5.1 in near future). You'll have to explicity add a dependency in your Gemfile:
