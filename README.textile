...
*Update 12/2017* : wow, if you read this, I hope you won't have to use this legacy code in Rails 5 like me. Consider "Kiba, a rewritten alternative":https://github.com/thbar/kiba and maintained.

Anyway, this fork is intended to bring support for Rails 5.0 (possibly 5.1 in near future). You'll have to explicity add a dependency in your Gemfile:

@gem 'activewarehouse-etl', github: "Autrement/activewarehouse-etl"@
@gem 'adapter_extensions', github: "colinux/adapter_extensions" # add this@
